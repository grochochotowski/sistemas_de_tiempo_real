...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#31a7a9e6#;
   ...
   u00121 : constant Version_32 := 16#22903fae#;
   pragma Export (C, u00121, "all_typesS");
   u00122 : constant Version_32 := 16#794bf815#;
   pragma Export (C, u00122, "calculate_optimal_controlB");
   u00123 : constant Version_32 := 16#7265fcf7#;
   pragma Export (C, u00123, "calculate_optimal_controlS");
   u00124 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00124, "ada__float_text_ioB");
   u00125 : constant Version_32 := 16#39060f6c#;
   pragma Export (C, u00125, "ada__float_text_ioS");
   ...
   u00129 : constant Version_32 := 16#6424aad3#;
   pragma Export (C, u00129, "system__img_fltS");
   u00130 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00130, "system__float_controlB");
   u00131 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00131, "system__float_controlS");
   u00132 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00132, "system__img_utilB");
   u00133 : constant Version_32 := 16#44802e3b#;
   pragma Export (C, u00133, "system__img_utilS");
   u00134 : constant Version_32 := 16#690df0ad#;
   pragma Export (C, u00134, "system__powten_fltS");
   u00135 : constant Version_32 := 16#c90890af#;
   pragma Export (C, u00135, "system__img_lfltS");
   u00136 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00136, "system__fat_lfltS");
   u00137 : constant Version_32 := 16#b684afd1#;
   pragma Export (C, u00137, "system__img_lluS");
   u00138 : constant Version_32 := 16#0be1c959#;
   pragma Export (C, u00138, "system__powten_lfltS");
   u00139 : constant Version_32 := 16#1422974c#;
   pragma Export (C, u00139, "system__img_llfS");
   u00140 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00140, "system__fat_llfS");
   u00141 : constant Version_32 := 16#b6fa998a#;
   pragma Export (C, u00141, "system__powten_llfS");
   u00142 : constant Version_32 := 16#18ee5867#;
   pragma Export (C, u00142, "system__val_fltS");
   u00143 : constant Version_32 := 16#8aea7eed#;
   pragma Export (C, u00143, "system__exn_fltS");
   u00144 : constant Version_32 := 16#0414e57b#;
   pragma Export (C, u00144, "system__val_lfltS");
   u00145 : constant Version_32 := 16#34ab9f34#;
   pragma Export (C, u00145, "system__exn_lfltS");
   u00146 : constant Version_32 := 16#de111da4#;
   pragma Export (C, u00146, "system__val_llfS");
   u00147 : constant Version_32 := 16#19055f44#;
   pragma Export (C, u00147, "system__exn_llfS");
   u00148 : constant Version_32 := 16#2d9021e1#;
   pragma Export (C, u00148, "check_security_setpointB");
   u00149 : constant Version_32 := 16#28e744be#;
   pragma Export (C, u00149, "check_security_setpointS");
   u00150 : constant Version_32 := 16#18445903#;
   pragma Export (C, u00150, "ada__directoriesB");
   u00151 : constant Version_32 := 16#6e6aef73#;
   pragma Export (C, u00151, "ada__directoriesS");
   ...
   u00161 : constant Version_32 := 16#c2b5739f#;
   pragma Export (C, u00161, "ada__directories__hierarchical_file_namesB");
   u00162 : constant Version_32 := 16#752941c9#;
   pragma Export (C, u00162, "ada__directories__hierarchical_file_namesS");
   u00163 : constant Version_32 := 16#4fedafb0#;
   pragma Export (C, u00163, "ada__directories__validityB");
   u00164 : constant Version_32 := 16#498b13d5#;
   pragma Export (C, u00164, "ada__directories__validityS");
   u00165 : constant Version_32 := 16#0de7ae30#;
   pragma Export (C, u00165, "ada__strings__fixedB");
   u00166 : constant Version_32 := 16#64881af1#;
   pragma Export (C, u00166, "ada__strings__fixedS");
   u00167 : constant Version_32 := 16#bb264ce2#;
   ...
   u00169 : constant Version_32 := 16#42b36dfe#;
   pragma Export (C, u00169, "ada__strings__unboundedB");
   u00170 : constant Version_32 := 16#da258d18#;
   ...
   u00172 : constant Version_32 := 16#86f92099#;
   ...
   u00174 : constant Version_32 := 16#3cf6ef27#;
   ...
   u00176 : constant Version_32 := 16#9ba67c99#;
   pragma Export (C, u00176, "system__atomic_countersS");
   u00177 : constant Version_32 := 16#c9a3fcbc#;
   pragma Export (C, u00177, "system__stream_attributesB");
   u00178 : constant Version_32 := 16#414158da#;
   pragma Export (C, u00178, "system__stream_attributesS");
   u00179 : constant Version_32 := 16#3e25f63c#;
   pragma Export (C, u00179, "system__stream_attributes__xdrB");
   u00180 : constant Version_32 := 16#ce9a2a0c#;
   pragma Export (C, u00180, "system__stream_attributes__xdrS");
   u00181 : constant Version_32 := 16#4f884ac4#;
   pragma Export (C, u00181, "system__file_attributesS");
   u00182 : constant Version_32 := 16#ac356f76#;
   pragma Export (C, u00182, "system__os_constantsS");
   u00183 : constant Version_32 := 16#b9a3a304#;
   pragma Export (C, u00183, "system__regexpB");
   u00184 : constant Version_32 := 16#0cc8f6d8#;
   pragma Export (C, u00184, "system__regexpS");
   ...
   u00187 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00187, "system__img_biuS");
   u00188 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00188, "system__img_llbS");
   u00189 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00189, "system__img_lliS");
   u00190 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00190, "system__img_lllbS");
   u00191 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00191, "system__img_llliS");
   u00192 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00192, "system__img_lllwS");
   u00193 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00193, "system__img_llwS");
   u00194 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00194, "system__img_wiuS");
   u00195 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00195, "system__val_intS");
   u00196 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00196, "system__val_unsS");
   u00197 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00197, "system__val_llliS");
   u00198 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00198, "system__val_llluS");
   ...
   u00201 : constant Version_32 := 16#0f4d1aee#;
   pragma Export (C, u00201, "global_flagsS");
   u00202 : constant Version_32 := 16#da83d03a#;
   pragma Export (C, u00202, "read_dataB");
   u00203 : constant Version_32 := 16#94e87163#;
   pragma Export (C, u00203, "read_dataS");
   u00204 : constant Version_32 := 16#678e2853#;
   pragma Export (C, u00204, "show_on_screenB");
   u00205 : constant Version_32 := 16#1532920b#;
   pragma Export (C, u00205, "show_on_screenS");
   u00206 : constant Version_32 := 16#b228e591#;
   pragma Export (C, u00206, "write_on_data_logB");
   u00207 : constant Version_32 := 16#63ee25c2#;
   pragma Export (C, u00207, "write_on_data_logS");
   ...
   --  all_types%s
   --  calculate_optimal_control%s
   --  calculate_optimal_control%b
   --  check_security_setpoint%s
   --  check_security_setpoint%b
   --  global_flags%s
   --  read_data%s
   --  read_data%b
   --  show_on_screen%s
